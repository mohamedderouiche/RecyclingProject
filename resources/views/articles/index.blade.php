...
<body id="page-top">
    ...
    <a href="{{ route('articles.create') }}" class="btn btn-primary mb-3 btn-sm">Create New Article</a>
                    ...
                    <td>
                        <div class="btn-group" role="group" aria-label="Actions">
                            ...
                            <form action="{{ route('articles.destroy', $article->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-link action-btn" title="Delete" onclick="return confirm('Are you sure you want to delete this article?');">
