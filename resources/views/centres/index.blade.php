                            ...
                            <tbody>
                                @foreach ($data as $centre)
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Edit Icon -->
                                            <a href="{{ url('/updatecentre', $centre->id) }}" class="btn btn-info" title="Edit">
                                            ...
                                            <form action="{{ route('centres.destroy', $centre->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this centre?');" title="Delete">
