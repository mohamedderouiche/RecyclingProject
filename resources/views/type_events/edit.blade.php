                        ...
                        <div class="col-md-6">
                            ...
                            <form action="{{ route('type_events.update', $typeEvent->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="title" name="title" value="{{ old('title', $typeEvent->title) }}" class="form-control" required>
                                </div>

                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <textarea id="description" name="description" class="form-control" required>{{ old('description', $typeEvent->description) }}</textarea>
                                </div>
